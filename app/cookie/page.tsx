  ...
  return (
    <>
      <Wrapper>
        ...
        <p>
          {" "}
          Administratorem Pani/Pana danych osobowych jest Jarosław Janas, adres
          e-mail: dzarekcoding@gmail.com tel. 798 194 305.{" "}
        </p>
        <p>
          {" "}
          ...
          stronie internetowej https://dzarek-nextjs-mysql.xaa.pl/. Dane mogą
          być zbierane także podczas firmowych eventów jak wystawy, targi,
          pokazy.{" "}
        </p>
        <p>
          {" "}
          Nasza strona internetowa https://dzarek-nextjs-mysql.xaa.pl/ nie
          zbiera w sposób automatyczny żadnych informacji, z wyjątkiem
          informacji zawartych w plikach cookies. Więcej o plikach cookies (tzw.
          „ciasteczka”) w naszej Polityce cookies.{" "}
        </p>
        <p>
          {" "}
